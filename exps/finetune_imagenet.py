...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.evaluate:
        while True:
            evaluate(test_loader, test_loader, net, attack_net,
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if epoch == args.epochs - 1:
            ...
            val_acc, val_los = evaluate(test_loader, sub_test_loader,
                                        net, attack_net, criterion, mean, std,
                                        stack_kernel, args, log)
...
def evaluate(test_loader, attack_loader, net, attack_net,
             criterion, mean, std, stack_kernel, args, log):
