...
class _BayesBatchNormIMP(Module):
    r"""
    ...
    def __init__(self, num_features, eps=1e-5, momentum=0.1, affine=True, 
        ...
        super(_BayesBatchNormIMP, self).__init__()
    ...
    def _load_from_state_dict(self, state_dict, prefix, local_metadata, strict,
        ...
        super(_BayesBatchNormIMP, self)._load_from_state_dict(
            state_dict, prefix, local_metadata, strict,
            missing_keys, unexpected_keys, error_msgs)

class BayesBatchNorm2dIMP(_BayesBatchNormIMP):
    r"""
...
class BayesBatchNorm1dIMP(_BayesBatchNormIMP):
    def _check_input_dim(self, input):
